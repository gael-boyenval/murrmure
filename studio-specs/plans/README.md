...
| [2026-07-14-tutorial-v3-build-tasks/](./2026-07-14-tutorial-v3-build-tasks/) | **Ordered implementation backlog** — 16 dependency-ordered, mostly vertical tasks; Task 00's accepted [contract ownership packet](../ADR/ADR-005-tutorial-v3-contract-ownership.md) and progressive harness are the fixed input to Tasks 01–14; **Task 15** closes deferred legacy v2 runtime, CLI typecheck, and v2 docs cutover from Tasks 13–14 |
