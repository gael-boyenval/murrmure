...
Murrmure v2 core (space directory, session/run, invoke, **unified step contracts v2.2**, step outputs, flow scaffold, **ViewCanvasHost** at human steps) is **shipped**. This page records **backlog symptom status** (B1–B10) and **what works today**.
