      ...
      "/guide/": [
        {
          ...
          items: [
            ...
            { text: "Meetings", link: "/guide/meetings" },
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: "1b — Meetings",
              link: "/guide/tutorials/02-meetings/",
              items: [
                { text: "Overview", link: "/guide/tutorials/02-meetings/" },
                { text: "1 — Two spaces", link: "/guide/tutorials/02-meetings/01-two-spaces" },
                { text: "2 — Personas", link: "/guide/tutorials/02-meetings/02-personas" },
                { text: "3 — Meeting flow", link: "/guide/tutorials/02-meetings/03-meeting-flow" },
                { text: "4 — Run & read the room", link: "/guide/tutorials/02-meetings/04-run-and-read-the-room" },
                { text: "5 — Wake seats", link: "/guide/tutorials/02-meetings/05-wake-seats" },
                { text: "6 — Talk & advance", link: "/guide/tutorials/02-meetings/06-talk-and-advance" },
                { text: "7 — Headless & cleanup", link: "/guide/tutorials/02-meetings/07-headless-and-cleanup" },
              ],
            },
          ],
        },
