...
4. **`murrmure_resolve_step`** — complete active flow step: `{ run_id, step_id, branch, payload }`
...
7. **`murrmure_wait_for_run`** — poll until run advances or human step completes
8. `murrmure_get_run` — inspect step memo + outputs
